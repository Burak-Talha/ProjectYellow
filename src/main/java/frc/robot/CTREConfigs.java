...
public final class CTREConfigs {
    ...
    public CTREConfigs(){
        ...
        swerveAngleFXConfig.CurrentLimits.StatorCurrentLimit = Constants.Swerve.angleCurrentThreshold;   ////  SupplyCurrentThreshold
        swerveAngleFXConfig.CurrentLimits.SupplyCurrentLowerTime = Constants.Swerve.angleCurrentThresholdTime; //// SupplyCurrentThreshold
